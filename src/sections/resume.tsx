      ...
      <div className="item-section mb-5">
        ...
        <div className="w-full space-y-5">
          ...
          <p className="text-gray-600">
            ...
            voluptatem voluptatibus enim voluptas necessitatibus. Aut quasi sunt
            dolor. Commodi dolores saepe asperiores beatae voluptate corporis
            est ea voluptatem. Enim quo sed et sint aspernatur distinctio qui
            quam.
          </p>
